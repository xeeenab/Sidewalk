...
export const anchorIssuesQuerySchema = z.object({
  status: z.enum(['ALL', 'ANCHOR_FAILED', 'ANCHOR_QUEUED']).default('ALL'),
...
export type AnchorIssuesQueryDTO = z.infer<typeof anchorIssuesQuerySchema>;
